...
{
    public partial class Region_Read : System.Web.UI.Page
    {
        ...
        protected void btnGenerateReports_Click(object sender, EventArgs e)
        {
            ...
            String strSQL = "";
            strSQL = "SELECT RegionDescription";
            strSQL += " FROM Region ";
            strSQL += " ORDER BY RegionDescription ";
            ...
            {
                txtOutput.Text = txtOutput.Text + objsqlDataReader["RegionDescription"].ToString()  + "\r";
